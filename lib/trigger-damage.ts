...
const overlimit = [
  ...
  { name: "物法兼得", href: "/overlimit/20703040444", perkSlug: "slot-3/物法兼得", overlimitId: "20703040444", trigger: "技能伤害后 5 秒内，射击追加伤害", interval: "追加 0.25 秒", numericalId: "130103016", damageType: "间接伤害", damageValue: "上次技能伤害 × 35%", toughness: 0.35, element: "物理", critical: false, weakpoint: false, weakpointMultiplier: 1 },
  ...
  { name: "爆毒蚀域", href: "/overlimit/20703040474", perkSlug: "slot-4/爆毒蚀域", overlimitId: "20703040474", trigger: "暴击时投出毒液罐并留下毒池", interval: "投掷 5 秒；每秒结算", numericalId: "121500071", damageType: "持续伤害", damageValue: "50/秒", toughness: 0, element: "腐蚀", critical: true, weakpoint: false, weakpointMultiplier: 1 },
