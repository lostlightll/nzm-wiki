...
const current = [
  ...
  { name: "连锁电环", href: "/perks/slot-4/连锁电环", perkSlug: "slot-4/连锁电环", trigger: "一次开火命中至少 2 次或至少 2 个目标", interval: "5 秒", numericalId: "11010085", damageType: "技能伤害", damageValue: "50", toughness: 0, element: "电弧", critical: false, weakpoint: false, weakpointMultiplier: 1 },
  { name: "释能火环", href: "/perks/slot-4/释能火环", perkSlug: "slot-4/释能火环", trigger: "释放技能", interval: "3 秒", numericalId: "11010086", damageType: "技能伤害", damageValue: "170", toughness: 0, element: "火焰", critical: false, weakpoint: false, weakpointMultiplier: 1 },
...
const overlimit = [
  ...
  { name: "爆毒蚀域", href: "/overlimit/20703040474", perkSlug: "slot-4/爆毒蚀域", overlimitId: "20703040474", trigger: "暴击时投出毒液罐并留下毒池", interval: "5 秒", numericalId: "121500071", damageType: "持续伤害", damageValue: "350/秒", toughness: 0.7, element: "腐蚀", critical: true, weakpoint: false, weakpointMultiplier: 1 },
  ...
  { name: "近战冲击", href: "/overlimit/20704040485", perkSlug: "slot-4/近战冲击", overlimitId: "20704040485", trigger: "近战命中有 50% 概率产生 5 米冲击波", interval: "1 秒", numericalId: "112042220", damageType: "技能伤害", damageValue: "375", toughness: 0.75, element: "物理", critical: true, weakpoint: false, weakpointMultiplier: 1 },
] satisfies readonly TriggerDamageEntry[];
