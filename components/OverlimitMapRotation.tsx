          ...
          >
            {activeBonds.map((bond) => {
              return (
                <span
                  key={bond}
                  className="inline-flex min-h-7 items-center gap-1 rounded border px-2 py-1 text-xs font-medium"
                  style={getOverlimitBondSurfaceStyle(bond)}
                >
                  <OverlimitBondIcon name={bond} />
                  {bond}
                </span>
              );
            })}
                ...
                >
                  ...
                  <span
                    className={`text-xs font-semibold ${
                      active ? "text-current" : "text-zinc-500"
                    }`}
                  >
                    {active ? "上架" : "下架"}
                  </span>
